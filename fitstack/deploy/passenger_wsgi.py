...
(here, /fitstack/api) has already been stripped from PATH_INFO by the time
...
# IMPORTANT: after this rename, the cPanel "Setup Python App" Application URL
# for this app must ALSO be updated to /fitstack/api to match - that's a
# server-side control-panel setting, not something version-controlled here.
MOUNT_PREFIX = "/fitstack/api"
