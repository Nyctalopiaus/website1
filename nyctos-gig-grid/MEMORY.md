...
| [`logs/cron_sync_log/`](file:///c:/Users/joshu/OneDrive/Documents/AI%20Projects/Website1/vm_code/nyctos-gig-grid/logs/cron_sync_log) | Target directory for daily market sync logs, log rotation archives, and security audit logs. Underscore, not hyphen -- must match the cPanel cron jobs' `>>` redirect target (those jobs live outside this codebase). |
