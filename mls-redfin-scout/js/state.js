 ...
 */
    ...
    export const elements = {
        ...
        btnUserPassword: document.getElementById('btn-user-password'),
        btnPlaylists: document.getElementById('btn-playlists'),
        modalPlaylists: document.getElementById('modal-playlists'),
        modalPlaylistsClose: document.getElementById('modal-playlists-close'),
        formCreatePlaylist: document.getElementById('form-create-playlist'),
        btnRealtorPortal: document.getElementById('btn-realtor-portal'),
        modalRealtorPortal: document.getElementById('modal-realtor-portal'),
        modalRealtorPortalClose: document.getElementById('modal-realtor-portal-close'),

        modalUserProfile: document.getElementById('modal-user-profile'),
        modalUserProfileClose: document.getElementById('modal-user-profile-close'),
        formUserProfile: document.getElementById('form-user-profile'),
        btnCancelUserProfile: document.getElementById('btn-cancel-user-profile'),

        modalPasswordMgmt: document.getElementById('modal-password-mgmt'),
        modalPasswordMgmtClose: document.getElementById('modal-password-mgmt-close'),
        formPasswordMgmt: document.getElementById('form-password-mgmt'),
        btnCancelPasswordMgmt: document.getElementById('btn-cancel-password-mgmt'),
        ...
        newUserIsAdmin: document.getElementById('new-user-is-admin'),
