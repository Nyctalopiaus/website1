      ...
      if (data.error) {
        if (data.cached === false) {
          showImportStatus(`
            ...
            Use the 🔖 <strong>Import to Nycto.ninja</strong> bookmarklet (from <a href="../housenomics/index.html" style="color: var(--accent-cyan);">Housenomics</a>) while viewing this listing to add it to the cache, then come back and click Load Property again.
          `, 'warn');
          return;
        }
